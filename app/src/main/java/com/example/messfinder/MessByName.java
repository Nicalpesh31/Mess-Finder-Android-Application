...
public class MessByName extends Activity {
    SQLiteDatabase db1;
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.messbyname);
        ...
        try {
            ...
            lst1.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    try {
                        ...
                        Intent i1= new Intent(MessByName.this,MessDetails.class);
                        ...
                        Toast.makeText(MessByName.this,""+e,Toast.LENGTH_LONG).show();
                    }
            ...
            b1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    LevelAdapter l1 = new LevelAdapter(MessByName.this, hname, contact, address);
                    lst1.setAdapter(l1);
