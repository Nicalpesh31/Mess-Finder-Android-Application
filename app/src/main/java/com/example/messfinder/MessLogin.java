...
public class MessLogin extends Activity {
    Button main_login;
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.messlogin);
            ...
            public void onClick(View view) {
               ...
               String role="";
                ...
                if(status){
                   ...
                   Intent i1= new Intent(MessLogin.this,AdminDashboard.class);
                   startActivity(i1);
                    }else{
                        ...
                        if(isfound){
                            Toast.makeText(MessLogin.this,"Role"+role,Toast.LENGTH_LONG).show();
                            SharedPreferences shr= PreferenceManager.getDefaultSharedPreferences(MessLogin.this);
                           ...
                           // if(role.contentEquals("Mess Owner")){
                                Intent i1= new Intent(MessLogin.this,MessDashboard.class);
                                startActivity(i1);
