...
public class ViewAllOrders extends Activity {
    SQLiteDatabase db1;
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        try {
                   ...
                   // String str11=et1.getText().toString();
                    ...
                    SharedPreferences shr= PreferenceManager.getDefaultSharedPreferences(ViewAllOrders.this);
                  ...
                  //  }
                    ...
                    LevelAdapter l1 = new LevelAdapter(ViewAllOrders.this, hname, ucon, address);
                    lst1.setAdapter(l1);
            ...
            Toast.makeText(ViewAllOrders.this,""+e,Toast.LENGTH_LONG).show();
        }
