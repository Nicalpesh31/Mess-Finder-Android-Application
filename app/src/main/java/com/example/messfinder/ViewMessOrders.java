...
public class ViewMessOrders extends Activity {
    SQLiteDatabase db1;
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        try {
                   ...
                   // String str11=et1.getText().toString();
                    ...
                    SharedPreferences shr= PreferenceManager.getDefaultSharedPreferences(ViewMessOrders.this);
                    ...
                    while (c1.moveToNext()) {
                       ...
                       if(c1.getString(3).toLowerCase().trim().contentEquals(name.toLowerCase().trim())) {
                    ...
                    LevelAdapter l1 = new LevelAdapter(ViewMessOrders.this, hname, ucon, address);
                    lst1.setAdapter(l1);
            ...
            Toast.makeText(ViewMessOrders.this,""+e,Toast.LENGTH_LONG).show();
        }
