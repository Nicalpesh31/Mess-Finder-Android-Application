...
public class ViewNearByMess extends Activity {
    SQLiteDatabase db1;
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.viewnearbymess);
            ...
            lst1.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    try {
                        ...
                        Intent i1= new Intent(ViewNearByMess.this,MessDetails.class);
                        ...
                        Toast.makeText(ViewNearByMess.this,""+e,Toast.LENGTH_LONG).show();
                    }
            ...
            b1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    while (c1.moveToNext()) {
                       ...
                       if(c1.getString(4).toLowerCase().trim().contentEquals(str11.toLowerCase().trim())) {
                    ...
                    LevelAdapter l1 = new LevelAdapter(ViewNearByMess.this, hname, contact, address);
                    lst1.setAdapter(l1);
